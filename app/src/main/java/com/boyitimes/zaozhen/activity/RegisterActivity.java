...
import com.boyitimes.zaozhen.twebview.ui.TWebViewAct;
...
public class RegisterActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        txt_denglu = findViewById(R.id.txt_denglu);
        ...
        txt_huoquyanzhengma.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!"".equals(edt_shoujihao.getText().toString()) && edt_shoujihao.getText().toString().length() == 11) {
                    mDialog = LoadingDialogUtils.createLoadingDialog(RegisterActivity.this, "请稍等...");
                    method = "verification";
...
//                startActivity(intent);
                if (!"".equals(edt_shoujihao.getText().toString()) && edt_shoujihao.getText().toString().length() == 11) {
                    if (!"".equals(edt_yanzhengma.getText().toString()) && edt_yanzhengma.getText().toString().length() == 6) {
                        if (!"".equals(edt_mima.getText().toString()) && edt_mima.getText().toString().length() > 6) {
                            ...
                            Toast.makeText(RegisterActivity.this, "请输入正确密码", Toast.LENGTH_LONG).show();
                        }
        ...
        txt_denglu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                finish();
            }
    ...
    private class HttpTask extends AsyncTask<String, Integer, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            switch (strings[0]) {
                case "login":
                    result = OkHttpClientRequest.get().SentRequest("dongzhongapi.boyitimes.com/api/reg/phonereg", getDenglu());
                    break;
                case "verification":
